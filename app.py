...
if option == "28 Features":
    ...
    inputs_standard.append(0.0)  # Append fixed value for standard input if needed
    ...
    if len(inputs_minmax) != len(minmax_features_28) or len(inputs_standard) != len(standard_features_28) + 1:  # +1 for Kurtosis_RB
        ...
        try:
            ...
            scaled_standard = standard_scaler_28.transform([inputs_standard[:-1]])  # Exclude fixed Kurtosis_RB from standard
